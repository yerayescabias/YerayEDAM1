								...
								<div class="container-fluid collapse navbar-collapse justify-content-center" style="color:white" id="collapsibleNavbar">
									<ul class="navbar-nav">
										...
										<li class="nav-item mx-3">
											<a class="nav-link text-light" href="../PAGES/Lectures Bilboard.xml">News</a>
										</li>
										<li class="nav-item mx-3">
											<a class="nav-link text-light" href="../PAGES/Employment_Exchange_EN.html">Employment Exchange</a>
										</li>
										<li class="nav-item dropdown mx-1">
											...
											<ul class="dropdown-menu" style="background-color: #00A7C4">
												<li class="dropdown-item">
													<a class="nav-link text-light" href="../PAGES/Services_EN.html">Facilities</a>
												</li>
												<li class="dropdown-item">
													<a class="nav-link text-light" href="../PAGES/STAFF.xml">Staff</a>
												</li>
											</ul>
										</li>
										<li class="nav-item mx-3">
											<a class="nav-link text-light" href="../PAGES/Contact_US_EN.html">Contact Us</a>
										</li>
										<li class="nav-item mx-4">
											<a class="nav-link text-light" href="../PAGES/Login.html">Login</a>
										</li>
									</ul>
								</div>
							</div>
