...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<body class="container-fluid">
		<header class=" m-auto w-100 ">
			...
			<div class="container-fluid mt-2 clearfix">
				<nav class="navbar navbar-expand-lg ">
							<div class="container-fluid">
								<!-- Logo -->
								<a class="navbar-brand" href="indexEUS.html">
								...
								<div class="container-fluid collapse navbar-collapse justify-content-center" style="color:white" id="collapsibleNavbar">
									<ul class="navbar-nav">
										<li class="nav-item mx-4">
											<a class="nav-link active text-light" href="indexEUS.html">Hasiera</a>
										</li>
										<li class="nav-item mx-3">
											<a class="nav-link text-light" href="Lectures BilboardEUS.xml">Berriak</a>
										</li>
										<li class="nav-item mx-3">
											<a class="nav-link text-light" href="Employment_Exchange_EU.html">Enplegu Poltsa</a>
										</li>
										<li class="nav-item dropdown mx-1">
											...
											<ul class="dropdown-menu" style="background-color: #00A7C4">
												<li class="dropdown-item">
													<a class="nav-link text-light" href="Services_EU.html">Azpiegiturak</a>
												</li>
												<li class="dropdown-item">
													<a class="nav-link text-light" href="STAFF_EU.xml">Lantaldea</a>
												</li>
											</ul>
										</li>
										<li class="nav-item mx-3">
											<a class="nav-link text-light" href="Contact_US_EU.html">Kontaktua</a>
										</li>
										<li class="nav-item mx-4">
											<a class="nav-link text-light" href="Login_EU.html">Hasi saioa</a>
										</li>
									</ul>
								</div>
							</div>
		...
		<h1 class="h1 ps-5 text-info">Berriak</h1>
			...
			<div id="demo" class="carousel slide py-3 " data-bs-ride="carousel">
				  ...
				  <div class="carousel-inner px-5 "  data-bs-interval="3000">
					<div class="carousel-item active">
						<img src="../images\AlkateEUS.jpg"  class="d-block w-100 "/>
					  
					</div>
					<div class="carousel-item"  data-bs-interval="3000">
					  <img src="../images\teatroEUS.png" class="d-block w-100 "/>
					</div>
					<div class="carousel-item"  data-bs-interval="3000">
					  <img src="../images\NewEU.jpg" class="d-block w-100 " />
					</div>
				  </div>
		...
		<h1 class="h1 ps-5 text-info">HITZALDIAK</h1>
		<br/>
		...
		<div class="row px-6">
			...
			<h5 class="py-2"> Sare sozialak</h5>
			<div class="row ps-4">
			...
			<div class="col-sm-5 border-start  ">
					...
					<h5 class="py-2" >Kontaktatu</h5>
					<div class="row">
						<div class="col pt-1">
							<h5 class="me-2" >Telf. zenbakia</h5 >
