				...
				<header class="m-auto w-100 ">
					...
					<div class="container-fluid mt-2 clearfix">
						<nav class="navbar navbar-expand-lg ">
							<div class="container-fluid">
								<!-- Logo -->
								<a class="navbar-brand" href="../PAGES/indexES.html">
								...
								<div class="container-fluid collapse navbar-collapse justify-content-center" style="color:white" id="collapsibleNavbar">
									<ul class="navbar-nav">
										<li class="nav-item mx-4">
											<a class="nav-link active text-light" href="../PAGES/indexES.html">Inicio</a>
										</li>
										<li class="nav-item mx-3">
											<a class="nav-link text-light" href="../PAGES/Lectures BilboardES.xml">Noticias</a>
										</li>
										<li class="nav-item mx-3">
											<a class="nav-link text-light" href="../PAGES/Employment_Exchange_EN.html">Bolsa de empleo</a>
										</li>
										<li class="nav-item dropdown mx-1">
											...
											<ul class="dropdown-menu" style="background-color: #00A7C4">
												<li class="dropdown-item">
													<a class="nav-link text-light" href="../PAGES/Services_ES.html">Instalaciones</a>
												</li>
												<li class="dropdown-item">
													<a class="nav-link text-light" href="../PAGES/STAFF_ES.xml">Equipo</a>
												</li>
											</ul>
										</li>
										<li class="nav-item mx-3">
											<a class="nav-link text-light" href="../PAGES/Contact_US_ES.html">Contacto</a>
										</li>
										<li class="nav-item mx-4">
											<a class="nav-link text-light" href="../PAGES/Login_ES.html">Inicio de sesión</a>
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="container-fluid">
						<div class="row px-6">
							...
							<div class="col-sm-5 border-start">
								<p class="py-2">Contacto</p>
								<div class="row">
									<div class="col pt-1">
										<p class="me-2">Número de teléfono</p>
