				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Etxebizitzak">
							...
							<tr>
								<td>
									<xsl:value-of select="EtxebizitzaID"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="Herria"/>
								</td>
								<td>
									<xsl:value-of select="Probintzia"/>
								</td>
								<td>
									<xsl:value-of select="Posta_x0020_kodea"/>
								</td>
								<td>
									<xsl:value-of select="M2"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Prezioa', '#,##0.00 €;-#,##0.00 €', '2', '3082', 6)"/>
								</td>
								<td>
									<xsl:value-of select="Bestelakoak"/>
								</td>
								<td>
									<xsl:value-of select="NAN"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Erosi', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Saldu', 'Yes/No', '', '', 11)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
