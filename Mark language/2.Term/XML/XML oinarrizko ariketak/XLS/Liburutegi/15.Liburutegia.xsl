		...
		<body>
				...
				<table border="3">
					...
					<xsl:choose>
						...
						<td bgcolor="red"><xsl:value-of select="izenburua"/></td>
						<td bgcolor="red"><xsl:value-of select="idazlea"/></td>
						<td bgcolor="red"><xsl:value-of select="isbn"/></td>
						<td bgcolor="red"><xsl:value-of select="orriak"/></td>
						
						</xsl:when>
						<xsl:when test="orriak &gt; 1000">
						<td bgcolor="green"><xsl:value-of select="izenburua"/></td>
						<td bgcolor="green"><xsl:value-of select="idazlea"/></td>
