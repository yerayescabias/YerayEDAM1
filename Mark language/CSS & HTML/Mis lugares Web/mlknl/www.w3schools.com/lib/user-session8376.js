        ...
        if (reqResDataParseRes.error.code !== '0') {
          ...
          if (
            ...
            output.error = {
              ...
              meta: {
                context: context,
                reqRes: UserSession._getDictSnapshot(reqResDataParseRes.data, false),
              }
            };
  ...
  if (
    ...
    if (!userSessionVerificationRes.error.meta.legacy) { // refresh the new way
      UserSession.refreshUserSession('UserSession.processUserSession', function (refreshUserSessionRes) {
        ...
        UserSession.processingRes = userSessionVerificationRes;
...
UserSession._getDictSnapshot = function (data, refFallback) {
  try {
